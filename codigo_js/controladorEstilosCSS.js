let estilosCSS = document.getElementById("estilosCSS");
let contenido2 = document.getElementById("content");
estilosCSS.addEventListener('click', contenidoPresentacion3);

function contenidoPresentacion3() {
